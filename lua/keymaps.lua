...
vim.keymap.set("n", "<leader>t5", "5gt", { desc = "Go to [t]ab 5" })
vim.keymap.set("n", "<leader>t6", "6gt", { desc = "Go to [t]ab 6" })
vim.keymap.set("n", "<leader>t7", "7gt", { desc = "Go to [t]ab 7" })
vim.keymap.set("n", "<leader>t8", "8gt", { desc = "Go to [t]ab 8" })
vim.keymap.set("n", "<leader>t9", "9gt", { desc = "Go to [t]ab 9" })
